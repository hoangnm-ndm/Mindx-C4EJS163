...
- Kiểm tra `length` phải là số nguyên dương nhỏ hơn 100, `prefix` nếu có phải là chuỗi nhỏ hơn 10 ký tự.
- Chuỗi id ngẫu nhiên được tạo ra (trừ phần prefix) thì chỉ được phép chứa các ký tự trong `listCharacters` bao gồm các ký tự chữ cái và số.
